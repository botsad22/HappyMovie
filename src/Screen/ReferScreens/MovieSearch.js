...
export default class MovieSearch extends Component {
    ...
    async componentWillMount(){
        ...
        return fetch(API.movie_search + global.searchKey)
  ...
  render() {
    ...
    return (
        ...
        renderItem={({item}) => 
        <TouchableOpacity style={styles.movieItem} onPress={() => {global.slug = item.slug; global.navigation.navigate('PlayScreen')}}>
            <ImageBackground
